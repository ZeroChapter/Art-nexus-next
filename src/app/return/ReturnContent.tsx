    ...
    <div className="content more-margin">
      ...
      <section className="information_block">
        <article className="page-information-block">
          ...
          <p>
            Товар, заказанный в интернет-магазине и не подошедший по каким-либо
            причинам, может быть возвращен в течение 14 дней.
            <br />
            <br />
            ...
            наличие оригинальной и неповрежденной упаковки и ярлыков); имеется
            подтверждение приобретения его в нашем интернет-магазине; сохранены
            потребительские свойства и товарный вид.
            <br />
            Для возврата товара, пожалуйста, свяжитесь c нами удобным для вас
            способом. <br />
            <br />
            art.nexus.russia@gmail.com <br />
            тел. +7 (993) 262-67-16 <br />
            @ArtNexus_Manager - Telegram
            <br />
